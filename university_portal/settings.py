...
ALLOWED_HOSTS = ["university-portal.onrender.com", "localhost"]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'university_portal'),
        'USER': os.environ.get('POSTGRES_USER', 'university_user'),
